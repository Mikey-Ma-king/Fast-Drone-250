...
struct AutoTakeoffLand_t
{
	...
	static constexpr double MOTORS_SPEEDUP_TIME = 0.0; // motors idle running for 3 seconds before takeoff
...
public:
	...
	double Odom_State = 0;//0 means no odom msg ,1 means use flow,2 means use vins 
