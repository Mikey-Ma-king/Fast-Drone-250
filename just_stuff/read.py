...
while not rospy.is_shutdown():
    ...
    if len(tags)>0:
        ...
        for tag in tags:
            ...
            if flag1%5 == 0:
                ...
                # print(flag1)
                # print("pos:",pos)
                if triger_callback == 0 or triger_callback == 1 :
                    main(pos)
                pos_copy = pos
                pos = []
            ...
            #     adjust_drone_position(center[0], center[1], 640, 480 , plane_tag)
    ...
    cv2.putText(global_image, f"0: {T3_1[0]}", (10, 90), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 1, cv2.LINE_AA)
    cv2.putText(global_image, f"1: {T3_1[1]}", (10, 110), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 1, cv2.LINE_AA)
