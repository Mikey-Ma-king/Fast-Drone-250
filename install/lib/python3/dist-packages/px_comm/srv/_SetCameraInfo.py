...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.camera_info.P))
      length = len(self.camera_info.M)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.camera_info.M))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.camera_info.camera_model = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.camera_info.camera_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.camera_info.camera_type = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      self.camera_info.P = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.camera_info.M = s.unpack(str[start:end])
      _x = self
      start = end
      end += 56
